//Darshan Mistry..
//Interfacing LCD and RFID with BBB..using I2C Bus
...
{  i2c_send_byte(0b00110100); // D7=0, D6=0, D5=1, D4=1, RS,RW=0 EN=1
   i2c_send_byte(0b00110000); usleep(4100);// D7=0, D6=0, D5=1, D4=1, RS,RW=0 EN=0 
   i2c_send_byte(0b00110100);  usleep(100); i2c_send_byte(0b00110000); 
   i2c_send_byte(0b00110100); usleep(4100);
   i2c_send_byte(0b00100100); i2c_send_byte(0b00100000); usleep(40); //4-bit mode set(2 nibble)
   LCD_cmd(0x28); usleep(40); // 4-bit mode with 2 lines char 5x8
   LCD_cmd(0x01);usleep(40);// delay 40usec
   LCD_cmd(0x06); usleep(40); //Increment cursor
...
char strg[]="1052452422";
          printf("%s",buff); // Print USID tag info 
          scanf("%s", buff);
